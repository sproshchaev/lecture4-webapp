...
public class PersonDAO {
    ...
    /**
     * Конструктор PersonDAO инициализирует переменные класса для JDBC в зависимости
    ...
    public PersonDAO() {
        ...
        if (this.osName.contains("Mac OS")) {
            this.jdbcUrl = "jdbc:sqlite:/Users/sproshchaev/Documents/Java/GIT/lecture4_webapp/db/lecture4.db";
        } else {
            this.jdbcUrl = "jdbc:sqlite:/Users/Сергей/Documents/Java/GIT/lecture4_webapp/db/lecture4.db";
        }
